<nav class="navbar navbar-expand-lg navbar-dark navhead" style="color: black; background-color: #556B2F; font-size: 18px;">
...
<!-- <img style="width: 80px; height: 30px;" src={{ "../images/LOGO.png" }} alt="Nothing"> -->
    ...
    <div class="collapse navbar-collapse" id="navbarColor01" style="color: black;">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('transports.index') }}">Transporter</a>
            </li>
            <li class="nav-item">
